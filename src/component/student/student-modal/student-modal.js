  ...
  return (
    <ReactModal
      ...
      <div className="modal-header">
        <button className="themed-button bg-alternative" onClick={props.onClose}>
            x
        </button>
      ...
      <div className="button-container">
        <button className="themed-button bg-alternative button-padding"
          onClick={() => setEditing(!isEditing)}>{isEditing ? 'Annuler' : 'Modifier l\'élève'}</button>
        <button className="themed-button bg-secondary button-padding"
          onClick={() => props.onDeleteStudent(student.id)}>Supprimer l&apos;élève</button>
      </div>
